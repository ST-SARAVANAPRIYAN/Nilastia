...
c_config_dir: Path = config_dir / "nilastia"
c_data_dir: Path = data_dir / "nilastia"
c_state_dir: Path = state_dir / "nilastia"
c_cache_dir: Path = cache_dir / "nilastia"
...
user_scheme_dir: Path = c_config_dir / "schemes"
