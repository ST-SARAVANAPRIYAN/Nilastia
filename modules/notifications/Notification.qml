...
StyledRect {
    ...
    color: (root.modelData?.urgency ?? NotificationUrgency.Low) === NotificationUrgency.Critical ? Colours.palette.m3secondaryContainer : Colours.tPalette.m3surfaceContainer
        ...
        Item {
            ...
            Loader {
                ...
                sourceComponent: StyledClippingRect {
                    ...
                    color: (root.modelData?.urgency ?? NotificationUrgency.Low) === NotificationUrgency.Critical ? Colours.palette.m3error : (root.modelData?.urgency ?? NotificationUrgency.Low) === NotificationUrgency.Low ? Colours.layer(Colours.palette.m3surfaceContainerHighest, 2) : Colours.palette.m3secondaryContainer
                ...
                sourceComponent: StyledRect {
                    ...
                    Loader {
                        ...
                        sourceComponent: ColouredIcon {
                            ...
                            colour: (root.modelData?.urgency ?? NotificationUrgency.Low) === NotificationUrgency.Critical ? Colours.palette.m3onError : (root.modelData?.urgency ?? NotificationUrgency.Low) === NotificationUrgency.Low ? Colours.palette.m3onSurface : Colours.palette.m3onSecondaryContainer
                    ...
                    Loader {
                        ...
                        sourceComponent: MaterialIcon {
                            text: Icons.getNotifIcon(root.modelData?.summary ?? "", root.modelData?.urgency ?? NotificationUrgency.Low)
                            color: (root.modelData?.urgency ?? NotificationUrgency.Low) === NotificationUrgency.Critical ? Colours.palette.m3onError : (root.modelData?.urgency ?? NotificationUrgency.Low) === NotificationUrgency.Low ? Colours.palette.m3onSurface : Colours.palette.m3onSecondaryContainer
            ...
            Item {
                ...
                StateLayer {
                    radius: Tokens.rounding.full
                    color: (root.modelData?.urgency ?? NotificationUrgency.Low) === NotificationUrgency.Critical ? Colours.palette.m3onSecondaryContainer : Colours.palette.m3onSurface
            ...
            ButtonRow {
                ...
                IconButton {
                    ...
                    inactiveColour: (root.modelData?.urgency ?? NotificationUrgency.Low) === NotificationUrgency.Critical ? Colours.palette.m3secondary : Colours.layer(Colours.palette.m3surfaceContainerHighest, 2)
                    inactiveOnColour: (root.modelData?.urgency ?? NotificationUrgency.Low) === NotificationUrgency.Critical ? Colours.palette.m3onSecondary : Colours.palette.m3onSurfaceVariant
                    icon: "close"
