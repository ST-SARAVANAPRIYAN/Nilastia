...
class Tokens : public QQuickAttachedPropertyPropagator, public QQmlParserStatus {
    ...
    Q_PROPERTY(const nilastia::config::AppearanceRounding* rounding READ rounding NOTIFY sourceChanged)
    Q_PROPERTY(const nilastia::config::AppearanceSpacing* spacing READ spacing NOTIFY sourceChanged)
    Q_PROPERTY(const nilastia::config::AppearancePadding* padding READ padding NOTIFY sourceChanged)
    Q_PROPERTY(const nilastia::config::AppearanceTransparency* transparency READ transparency NOTIFY sourceChanged)
    Q_PROPERTY(const nilastia::config::SizeTokens* sizes READ sizes NOTIFY sourceChanged)
    Q_PROPERTY(const nilastia::config::FontTokens* font READ font NOTIFY sourceChanged)
    Q_PROPERTY(const nilastia::config::AnimTokens* anim READ anim NOTIFY sourceChanged)
