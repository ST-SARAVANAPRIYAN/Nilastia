...
class BackgroundConfig : public ConfigObject {
    ...
    CONFIG_PROPERTY(bool, backdropEnabled, true)
    CONFIG_PROPERTY(bool, backdropUseMainWallpaper, true)
    CONFIG_PROPERTY(bool, backdropHideWallpaper, false)
    CONFIG_PROPERTY(QString, backdropWallpaperPath, QStringLiteral(""))
    CONFIG_PROPERTY(bool, backdropVignetteEnabled, true)
    CONFIG_PROPERTY(qreal, backdropVignetteIntensity, 0.5)
