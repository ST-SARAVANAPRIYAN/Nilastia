...
class EntryPointLoader : public QQuickItem {
    ...
    Q_PROPERTY(nilastia::plugins::EntryPoint entryPoint READ entryPoint WRITE setEntryPoint RESET resetEntryPoint
    ...
    Q_PROPERTY(nilastia::plugins::EntryPointLoader::Status status READ status NOTIFY statusChanged)
