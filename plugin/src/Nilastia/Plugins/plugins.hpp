...
// Backed by a single ~/.config/nilastia/plugins.json holding enabled + path + settings.
//
...
public:
    ...
    Q_INVOKABLE QList<EntryPoint> __entryPoints(nilastia::plugins::EntryPointType::Type type) const;
