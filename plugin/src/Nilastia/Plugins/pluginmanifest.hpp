...
class PluginManifest : public QObject {
    ...
    Q_PROPERTY(QList<nilastia::plugins::EntryPoint> entryPoints READ entryPoints NOTIFY entryPointsChanged)
    ...
    Q_PROPERTY(nilastia::plugins::SettingsObject* settings READ settings NOTIFY settingsChanged)
