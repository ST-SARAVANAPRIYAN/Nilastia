...
Q_LOGGING_CATEGORY(lcLyrics, "nilastia.lyrics", QtInfoMsg)
...
[[nodiscard]] const QHash<QByteArray, QByteArray>& lrclibHeaders() {
    static const QHash<QByteArray, QByteArray> h = {
        { "User-Agent"_ba, "nilastia-shell (https://github.com/nilastia-dots/shell)"_ba },
    };
    return h;
}
...
const QString& Lyrics::stateDir() {
    static const QString s_dir = [] {
        ...
        return state + u"/nilastia/lyrics"_s;
    }();
    return s_dir;
}
...
const QString& Lyrics::cacheDir() {
    static const QString s_dir = [] {
        ...
        return cache + u"/nilastia/lyrics"_s;
    }();
    return s_dir;
}
