...
class Lyrics : public QObject {
    ...
    Q_PROPERTY(nilastia::services::LyricsBackend::Backend backend READ backend NOTIFY backendChanged)
    Q_PROPERTY(nilastia::services::LyricsBackend::Backend preferredBackend READ preferredBackend WRITE
            setPreferredBackend NOTIFY preferredBackendChanged)
    Q_PROPERTY(
        QList<nilastia::services::LyricCandidate> lyricCandidates READ lyricCandidates NOTIFY lyricCandidatesChanged)
    Q_PROPERTY(nilastia::services::LyricCandidate selectedCandidate READ selectedCandidate WRITE setSelectedCandidate
